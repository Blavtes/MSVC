...
- (void)showTipView
{
    ...
    NoDataOrNetworkView *tipView = [[NoDataOrNetworkView alloc] initWithTipType:[self showTipViewDataType] touchTipBlock:^{
        __strong __typeof(weakSelf) strongSelf = weakSelf;
        if (strongSelf) {
            //  点击提示信息重新尝试
            [strongSelf defaultLoad];
        }
    }];
    tipView.isTouchRemove = YES;
